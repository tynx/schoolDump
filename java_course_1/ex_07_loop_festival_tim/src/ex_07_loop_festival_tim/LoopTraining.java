	...
	public static void main(String[] args) {
		...
		do{
			...
			if (!s.equals("")) {
				...
				// removed /3
				//DiamondGenerator diamondGen = new DiamondGenerator(n);
				System.out.println("A diamond with size length: " + n);
				DiamondGenerator diamondGen = new DiamondGenerator(n, " ", "*");
				...
				// Print all pythagorean triangles with integer sides, that have
				// an hypothenuse < n
				System.out.println("Pythagorean triangles with integer sides " +
						   "and hypothenuse < n:");
				TriangleGenerator triangleGen = new TriangleGenerator(n);
				System.out.println(triangleGen.getPythagorean());
			}
		} while (!s.equals(""));
		in.close();
	}
