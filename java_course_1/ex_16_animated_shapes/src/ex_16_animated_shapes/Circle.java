...
/**
 * This class is for the Circle-Shape for the animated shapes. It extends from
 * Shape, so it is just necessary to have a constructor and the draw function.
 * 
 * @author tim luginbuehl (lugtim@gmail.com // tynx.ch)
 * @author jerome jamin (jerome.jamin@gmail.com)
 */
public class Circle extends Shape implements MoveableShape{
	...
	/**
	 * This overwrittes the draw function, to make sure we draw an circle shape.
